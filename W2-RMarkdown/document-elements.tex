...
\includegraphics{document-elements_files/figure-latex/pressure-1.pdf}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\KeywordTok{head}\NormalTok{(cars),}
             \DataTypeTok{caption =} \StringTok{"cars dataset"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}rr@{}}
\caption{cars dataset}\tabularnewline
\toprule
